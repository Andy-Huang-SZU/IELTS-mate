"""
IELTS Official Band Descriptors (Public Version, Updated May 2023)

This module contains the official IELTS Writing Band Descriptors for both
Task 1 (Academic & General Training) and Task 2, used as scoring anchors
in the evaluation prompts.

Source: British Council / IDP / Cambridge — Public Band Descriptors
PDF: ielts-writing-band-descriptors.pdf (Updated May 2023)
Reference: ielts-writing-key-assessment-criteria.pdf

Band 0–9 full coverage. Text is verbatim from official documents.
"""
...
TASK2_TR = {
    ...
    7: (
        ...
        "Main ideas are extended and supported but there may be a tendency to over-generalise "
        "or there may be a lack of focus and precision in supporting ideas/material."
    ),
    6: (
        ...
        "Main ideas are relevant, but some may be insufficiently developed or may lack clarity, "
        "while some supporting arguments and evidence may be less relevant or inadequate."
    ),
    5: (
        ...
        "and/or there may be irrelevant detail. "
        "There may be some repetition."
    ),
    4: (
        "The prompt is tackled in a minimal way, or the answer is tangential, possibly due to some "
        "misunderstanding of the prompt. The format may be inappropriate. "
        "A position is discernible, but the reader has to read carefully to find it. "
        "Main ideas are difficult to identify and such ideas that are identifiable may lack relevance, "
    ...
    0: (
        "Should only be used where a candidate did not attend or attempt the question in any way, "
        "used a language other than English throughout, or where there is proof that a candidate's "
        "answer has been totally memorised."
    ),
}

# ═══════════════════════════════════════════════════════════════════════════
#  Task 1: Task Achievement (TA) — Academic
# ═══════════════════════════════════════════════════════════════════════════
...
TASK1_TA = {
    ...
    7: (
        ...
        "(Academic) Key features which are selected are covered and clearly highlighted but could be more "
        "fully or more appropriately illustrated or extended. "
        "(Academic) It presents a clear overview, the data are appropriately categorised, and main trends "
        "or differences are identified. "
        "(General Training) All bullet points are covered and clearly highlighted but could be more fully or "
        "more appropriately illustrated or extended. It presents a clear purpose. The tone is consistent and "
        "appropriate to the task. Any lapses are minimal."
    ),
    6: (
        "The response focuses on the requirements of the task and an appropriate format is used. "
        "(Academic) Key features which are selected are covered and adequately highlighted. A relevant "
        "overview is attempted. Information is appropriately selected and supported using figures/data. "
        "(General Training) All bullet points are covered and adequately highlighted. The purpose is "
        "generally clear. There may be minor inconsistencies in tone. "
        "Some irrelevant, inappropriate or inaccurate information may occur in areas of detail or when "
        "illustrating or extending the main points. "
        "Some details may be missing (or excessive) and further extension or illustration may be needed."
    ),
    5: (
        "The response generally addresses the requirements of the task. The format may be inappropriate "
        "in places. "
        "(Academic) Key features which are selected are not adequately covered. The recounting of detail "
        "is mainly mechanical. There may be no data to support the description. "
        "(General Training) All bullet points are presented but one or more may not be adequately covered. "
        ...
        "The inclusion of irrelevant, inappropriate or inaccurate material in key areas detracts from "
    ...
    4: (
        ...
        "(General Training) The purpose of the letter is not clearly explained and may be confused. "
        "The tone may be inappropriate. "
        "The format may be inappropriate. "
        "Key features/bullet points which are presented may be irrelevant, repetitive, inaccurate "
        "or inappropriate."
    ),
    3: (
        "The response does not address the requirements of the task (possibly because of misunderstanding "
        "of the data/diagram/situation). "
...
TASK2_CC = {
    ...
    7: (
        "Information and ideas are logically organised, and there is a clear progression throughout "
        "the response. (A few lapses may occur, but these are minor.) "
        "A range of cohesive devices including reference and substitution is used flexibly but with "
        "some inaccuracies or some over/under use. "
        "Paragraphing is generally used effectively to support overall coherence, and the sequencing "
    ...
    6: (
        ...
        "Cohesive devices are used to some good effect but cohesion within and/or between sentences "
        "may be faulty or mechanical due to misuse, overuse or omission. "
        "The use of reference and substitution may lack flexibility or clarity and result in some "
        "repetition or error. "
    ...
    4: (
        "Information and ideas are evident but not arranged coherently and there is no clear progression "
        "within the response. "
        "Relationships between ideas can be unclear and/or inadequately marked. There is some use of "
        "basic cohesive devices, which may be inaccurate or repetitive. "
    ...
    3: (
        ...
        "There is minimal use of sequencers or cohesive devices. Those used do not necessarily indicate "
...
TASK1_CC = {
    ...
    7: (
        "Information and ideas are logically organised and there is a clear progression throughout "
        "the response. A few lapses may occur. "
        "A range of cohesive devices including reference and substitution is used flexibly but with "
        "some inaccuracies or some over/under use."
    ),
    6: (
    ...
    3: (
        "There is no apparent logical organisation. Ideas are discernible but difficult to relate to each other. "
        "Minimal use of sequencers or cohesive devices. Those used do not necessarily indicate a logical "
...
TASK2_LR = {
    9: (
        ...
        "A wide range of vocabulary is used accurately and appropriately with very natural and "
        "sophisticated control of lexical features. "
        "Minor errors in spelling and word formation are extremely rare and have minimal impact "
        "on communication."
    ),
    8: (
        "A wide resource is fluently and flexibly used to convey precise meanings. "
        "There is skilful use of uncommon and/or idiomatic items when appropriate, despite "
        "occasional inaccuracies in word choice and collocation. "
        "Occasional errors in spelling and/or word formation may occur, but have minimal impact "
        "on communication."
    ),
    7: (
    ...
    6: (
        ...
        "The meaning is generally clear in spite of a rather restricted range or a lack of precision "
        "in word choice. "
        "If the writer is a risk-taker, there will be a wider range of vocabulary used but higher "
    ...
    5: (
        ...
        "Simple vocabulary may be used accurately but the range does not permit much variation "
        "in expression. "
        "There may be frequent lapses in the appropriacy of word choice and a lack of flexibility "
        "is apparent in frequent simplifications and/or repetitions. "
        "Errors in spelling and/or word formation may be noticeable and may cause some difficulty "
        "for the reader."
    ),
    4: (
        "The resource is limited and inadequate for or unrelated to the task. Vocabulary is basic "
        "and may be used repetitively. "
        "There may be inappropriate use of lexical chunks (e.g. memorised phrases, formulaic language "
    ...
    3: (
        ...
        "Control of word choice and/or spelling is very limited, and errors predominate. "
        "These errors may severely impede meaning."
    ),
    2: (
...
TASK1_LR = {
    ...
    8: (
        "A wide resource is fluently and flexibly used to convey precise meanings within the scope "
        "of the task. "
        "There is skilful use of uncommon and/or idiomatic items when appropriate, despite "
        "occasional inaccuracies in word choice and collocation. "
        "Occasional errors in spelling and/or word formation may occur, but have minimal impact "
...
TASK2_GRA = {
    ...
    8: (
        ...
        "Occasional, non-systematic errors and inappropriacies occur, but have minimal impact "
        "on communication."
    ),
    7: (
    ...
    6: (
        ...
        "Examples of more complex structures are not marked by the same level of accuracy as in "
        "simple structures. "
    ...
    5: (
        ...
        "Although complex sentences are attempted, they tend to be faulty, and the greatest accuracy "
    ...
    4: (
        ...
        "Some structures are produced accurately but grammatical errors are frequent and may "
        "impede meaning. "
        "Punctuation is often faulty or inadequate."
    ),
    3: (
        "Sentence forms are attempted, but errors in grammar and punctuation predominate "
        "(except in memorised phrases or those taken from the input material). "
...
# These are kept for backward compatibility but new code should use
# the task-specific variants via the getter functions below.
CC_DESCRIPTORS = TASK2_CC
LR_DESCRIPTORS = TASK2_LR
GRA_DESCRIPTORS = TASK2_GRA


# ═══════════════════════════════════════════════════════════════════════════
#  Formatting & Getter Functions
# ═══════════════════════════════════════════════════════════════════════════

def format_band_descriptors(
    descriptors: dict[int, str],
    criterion_name: str,
    band_range: tuple[int, int] = (5, 9),
) -> str:
    """Format band descriptors into a readable string for embedding in prompts.

    Args:
        descriptors: Dict mapping band score (int) to descriptor text.
        criterion_name: Display name of the criterion.
        band_range: Tuple of (min_band, max_band) to include. Default (5, 9)
                     for the main scoring range used in prompts. Use (0, 9)
                     for full coverage.
    """
    lo, hi = band_range
    lines = [f"### {criterion_name} — Official Band Descriptors (Band {lo}–{hi})\n"]
    for band in range(hi, lo - 1, -1):
        if band in descriptors:
            lines.append(f"**Band {band}**: {descriptors[band]}\n")
    return "\n".join(lines)


def get_tr_descriptors(task_type: str) -> str:
    """Get Task Response / Task Achievement descriptors based on task type."""
    if task_type == "part_a":
        return format_band_descriptors(TASK1_TA, "Task Achievement (Task 1)")
    return format_band_descriptors(TASK2_TR, "Task Response (Task 2)")


def get_cc_descriptors(task_type: str = "part_b") -> str:
    """Get Coherence and Cohesion descriptors based on task type."""
    if task_type == "part_a":
        return format_band_descriptors(TASK1_CC, "Coherence and Cohesion (Task 1)")
    return format_band_descriptors(TASK2_CC, "Coherence and Cohesion (Task 2)")


def get_lr_descriptors(task_type: str = "part_b") -> str:
    """Get Lexical Resource descriptors based on task type."""
    if task_type == "part_a":
        return format_band_descriptors(TASK1_LR, "Lexical Resource (Task 1)")
    return format_band_descriptors(TASK2_LR, "Lexical Resource (Task 2)")


def get_gra_descriptors(task_type: str = "part_b") -> str:
    """Get Grammatical Range and Accuracy descriptors based on task type."""
    if task_type == "part_a":
        return format_band_descriptors(TASK1_GRA, "Grammatical Range and Accuracy (Task 1)")
    return format_band_descriptors(TASK2_GRA, "Grammatical Range and Accuracy (Task 2)")
